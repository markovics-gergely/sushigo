...
namespace user.dal.Migrations
{
    ...
    [Migration("20230923191219_HistoryTime")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("user.dal.Domain.ApplicationUser", b =>
                {
                    ...
                    b.Property<Guid?>("ActiveGamePlayer")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("user.dal.Domain.ApplicationUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("user.dal.Domain.Friend", b =>
                {
                    ...
                    b.HasOne("user.dal.Domain.ApplicationUser", "Sender")
